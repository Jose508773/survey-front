...
async function sendData() {
    ...
    const response = await fetch('https://user-cervey-2bmamdjoh-jose-ochoas-projects-391a85d0.vercel.app/survey', {
...
async function fetchData() {
    try {
        const response = await fetch('https://user-cervey-2bmamdjoh-jose-ochoas-projects-391a85d0.vercel.app/responses');
